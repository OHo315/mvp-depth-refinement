...
# Edited to bypass multiple registers of the same module key by ignoring all subsequent attempts.
# Please replace env/lib/python3.10/site-packages/mmengine/registry/registry.py with this file.
...
class Registry:
    ...
    def _register_module(self,
        ...
        """
        if module_name == "PatchRefiner":
            print("REGISTER CALL", module_name)
        ...
        for name in module_name:
            if not force and name in self._module_dict:
                ...
                print(f'{name} is already registered in {self.name} '
                               f'at {existed_module.__module__}, ignoring register call')
            else:
