...
if "__main__" == __name__:
    ...
    parser.add_argument(
        "--split_csv",
        type=str,
        default="data_split/hypersim_depth/metadata_images_split_scene_v1_small.csv",
    )
    parser.add_argument("--dataset_dir", type=str, default="data/hypersim")
    parser.add_argument("--output_dir", type=str, default="data/hypersim_processed")
